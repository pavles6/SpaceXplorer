      ...
      {loading
        ? timer.map((item) => (
            <div className="flex-col flex items-center" key={item.type}>
              ...
              <p className="mt-1 text-xs sm:text-base font-semibold rounded-md dark:text-darkSecondary dark:bg-darkSecondary dark:animate-pulse bg-lightSecondary text-lightSecondary animate-pulse">
